...
export const TopProducers = (props: ComponentProps<typeof VStack>) => {
  return (
    <VStack {...props} align="flex-start" spacing={{ base: 6, '2xl': 8 }} height="full" pb={6}>
      ...
      <SimpleGrid columns={3} gap={{ base: 4, '2x1': 8 }}>
      ...
      <VStack flex={1} spacing={4} alignItems="flex-start" width="full">
        ...
        <VStack width="full" flex={1} bg="gray.dark" alignItems="center" justifyContent="center" rounded="lg">
          <Heading color="gray.light" fontWeight="normal" fontSize="xl"></Heading>
        </VStack>
      </VStack>
    </VStack>
  )
